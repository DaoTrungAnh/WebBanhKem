...
namespace AnhThuBakery.Controllers
{
    public class AdmincpController : Controller
    {
        ...
        //#region [Kích thước]
        //public ActionResult CreateKichThuoc()
        //{
        //    ViewBag.loai = db.LOAIBANHs.ToList();
        //    return View();
        //}
        //[HttpPost]
        //public ActionResult CreateKichThuoc(KichThuoc _model)
        //{
        //    TempData["title"] = "Thêm mới thành công !";
        //    db.KichThuocs.Add(_model);
        //    db.SaveChanges();
        //    return RedirectToAction("ListKichThuoc", "Admincp");
        //}

        //[HttpGet]
        //public ActionResult DeleteKichThuoc(string id)
        //{
        //    TempData["title"] = "Xóa thành công !";
        //    int t = int.Parse(id);
        //    KichThuoc model = db.KichThuocs.Where(i => i.MaKT == t).FirstOrDefault();
        //    if (model != null)
        //    {
        //        db.KichThuocs.Remove(model);
        //        db.SaveChanges();
        //    }
        //    return RedirectToAction("ListKichThuoc", "Admincp");
        //}
        //[HttpGet]
        //public ActionResult UpdateKichThuoc(string id)
        //{
        ...
        //[HttpPost]
        //public ActionResult UpdateKichThuoc(KichThuoc _model)
        //{
        //    TempData["title"] = "Cập nhật thành công !";
        //    KichThuoc model = db.KichThuocs.Where(i => i.MaKT == _model.MaKT).FirstOrDefault();
        //    if (model != null)
        //    {
        //        model.Kichthuoc1 = _model.Kichthuoc1;
        //        model.Maloai = _model.Maloai;
        //        db.SaveChanges();
        //    }
        //    return RedirectToAction("ListKichThuoc", "Admincp");
        //}

        //public ActionResult ListKichThuoc()
        //{
        //    List<KichThuoc> model = db.KichThuocs.ToList();
        //    return View(model);
        //}
        //#endregion
        ...
        public ActionResult ActiveGiaoHang(string idHD)
        {
            ...
            //List<CTDH> cthd = db.CTDHs.Where(m => m.MaDH == model.MaDH).ToList();
            //foreach (var i in cthd)
            //{
            //    BANH banh = db.BANHs.Where(m => m.MaBanh == i.MaBanh).FirstOrDefault();
            //    banh.DonGia = decimal.Parse(banh.DonGia.ToString());
            //    if (model.DaGiao == true)
            //        banh.SoLuongBan -= i.SoLuong;
            //    else
            //        banh.SoLuongBan += i.SoLuong;
            //    db.SaveChanges();
            //}
